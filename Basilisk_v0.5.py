...
root = tk.Tk()
root.title("Basilisk Toolkit ver0.5 ALPHA")
#root.geometry("600x1080")
root.geometry("1920x1080")
root.configure(bg="#47494d")
root.state("zoomed")
#root.resizable(False,False)
img = tk.PhotoImage(file="D:\Basilisk_Project\Basilisk.png")
...
def pscan():
    ...
    out = scapy.arping(allip,timeout=15)
...
main_txt = tk.Label(root, text="BASILISK v0.5", font=("Arial",25,"bold"), fg="#0CCA4A",bg="#47494d")
...
txt13.place(x=1200, y=64)
txt14.place(x=1230, y=90)
interface_name2.place(x=1230,y=110)
txt16.place(x=1260, y=131)
gate_waymac.place(x=1230,y=150)
txt17.place(x=1268, y=170)
gate_wayip.place(x=1230, y=190)
but9.place(x=1255, y=216)
txt15.place(x=1280,y=245)
out4.place(x=1230,y=265)
