...
img = tk.PhotoImage(file="D:\Basilisk_Project\Basilisk_log.png")
...
im = tk.PhotoImage(file="D:\Basilisk_Project\pp.png")
logo = tk.Label(root, image=im, bg="#47494d")
